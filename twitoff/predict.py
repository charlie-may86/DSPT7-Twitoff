...
def predict_user(user1, user2, tweet_text):
    '''Determine and return which user is more likely to say
    a given tweet

    # Arguments:
        user1 str, twitter user name for user1 in comparision from web form
        user2 str, twitter user name for user in comparision from web form
        tweet_text: str, tweet text to evalutate from web form
